  ...
  <div class="main-page">
    <div class="search_panel" ref="searchPanel">
      <div class="search_item">
        ...
        <el-input v-model="searchModel.keyword" placeholder="微信名称/店铺名称/电话号码"></el-input>
      </div>
      <el-button
        type="primary"
        @click="search"
      ...
      <el-button type="success" @click="synchro" icon="el-icon-sort" size="small">从微信同步用户</el-button>
    </div>
    <div class="search_list">
      <el-table
        ...
        stripe
      >
        <el-table-column prop="nickname" label="微信名称" min-width="25%"></el-table-column>
        <el-table-column prop="name" label="姓名" min-width="25%" header-align="center"></el-table-column>
        <el-table-column prop="phone" label="联系电话" min-width="15%" align="center"></el-table-column>
    ...
    >
      <template slot="content">
        <el-form ref="form" :model="modelForm" :rules="rules" label-width="80px">
          <el-form-item label="微信名称">{{modelForm.nickname}}</el-form-item>
